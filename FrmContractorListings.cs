...
namespace RewardAssured
{
    ...
    public partial class FrmContractorListings : Form
    {
        private BindingSource BindingSource1 = new BindingSource();
        private SqlDataAdapter dataAdapter1 = new SqlDataAdapter();
        int ReturnCode;
        string strQryMain;
        public FrmContractorListings()
        {
            InitializeComponent();
        }
        ...
        {
            FrmRegister ChildForm = new FrmRegister("Edit", ReturnCode);
        ...
        {
            FrmRegister ChildForm = new FrmRegister("Delete", ReturnCode);
            ChildForm.ShowDialog();
            LoadLvList(strQryMain);
        }
        ...
        {
            FrmRegister ChildForm = new FrmRegister("Browse", ReturnCode);
            ChildForm.ShowDialog();
            LoadLvList(strQryMain);
        }
        ...
        {
            FrmRegister ChildForm = new FrmRegister("New", 0);
            ChildForm.ShowDialog();
            LoadLvList(strQryMain);
        }
