 ...
 public partial class FrmList : Form
    {
        ...
        public object ReturnValue2 { get; set; }
        public object ReturnValue3 { get; set; }
...
private void cmdFind_Click(object sender, System.EventArgs e)
            ...
            switch (listQuery1)
            {
              ...
              break;
                ...
                case "Clients":
                    ...
                    //this.ReturnValue2 = this.Tag.ToString();
                    this.DialogResult = DialogResult.OK;
                    break;
                case "Services":
                    this.ReturnValue = DGrid.Tag.ToString();
        ...
        private void DGrid_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                ...
                ReturnValue1 = DGrid[1, e.RowIndex].Value;
                ReturnValue2 = DGrid[2, e.RowIndex].Value;
                ReturnValue3 = DGrid[3, e.RowIndex].Value;
            }
            catch
            {
